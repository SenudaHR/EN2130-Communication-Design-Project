...
import cdp_epy_block_5 as epy_block_5  # embedded python block
import cdp_epy_block_6 as epy_block_6  # embedded python block
import sip
...
class cdp(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._phase_bw_range = qtgui.Range(0.0, 1.0, 0.01, 0.005, 200)
        ...
        self._timing_loop_bw_range = qtgui.Range(0.0, 0.2, 0.001, 0.005, 200)
        ...
        for c in range(1, 2):
            self.controls_grid_layout_1.setColumnStretch(c, 1)
        self.epy_block_6 = epy_block_6.aes_decrypt(key=b"1234567890abcd30", iv=b"abcdef1234567890")
        self.epy_block_5 = epy_block_5.aes_encrypt(key=b"1234567890abcd30", iv=b"abcdef1234567890")
        ...
        self.epy_block_2_0 = epy_block_2_0.pdu_text_gui(wait_time=0.2, pkt_size=32, address=21, retry_limit=10, window_size=7)
        ...
        self.digital_linear_equalizer_0_0 = digital.linear_equalizer(32, 2, variable_adaptive_algorithm_0, True, [ ], 'corr_est')
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_crc_append_0, 'out'), (self.epy_block_5, 'in'))
        ...
        self.msg_connect((self.epy_block_3, 'out'), (self.epy_block_6, 'in'))
        ...
        self.msg_connect((self.epy_block_5, 'out'), (self.epy_block_0, 'in'))
        self.msg_connect((self.epy_block_6, 'out'), (self.epy_block_4_0, 'in'))
