...
class pdu_text_gui(gr.basic_block):
    ...
    def __init__(self, wait_time=2.0, pkt_size=32, address=0x01, retry_limit=100, window_size=4):
        ...
        self._has_acks = False    # tracks if any ACKs have been received
    ...
    def _run(self):
        ...
        # Determine starting seq_id
        if self._has_acks:
            # continue from the next unACKed sequence
        ...
        print(f"[pdu_text_gui] Starting new message at seq=0x{self._seq_id:02X}")
        ...
        try:
            ...
            with self._lock:
                ...
                for i in range(self._base, self._next_to_send):
                    ...
                    if seq_id == ack_id:
                        self._has_acks = True
                        self._last_ack_seq = ack_id  # save last ACKed seq
